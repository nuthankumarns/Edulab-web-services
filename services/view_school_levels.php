...
include'setup.php';
//www.tritonetech.com/php_uploads/porsche/webservice/view_school_levels.php?school_id=
...
$query=$_DB->Query("select * from jos_porsche_level where school_id='$school_id'");
